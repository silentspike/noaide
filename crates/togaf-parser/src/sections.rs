...
pub static TOGAF_SECTIONS: &[SectionDef] = &[
    ...
    SectionDef {
        ...
        phase_code: "P",
        number: 1,
        name: "Architecture Engagement Record",
        gate: Some(0),
        s: Tailoring::P,
        m: Tailoring::P,
        l: Tailoring::P,
    ...
    SectionDef {
        ...
        phase_code: "H",
        number: 3,
        name: "Architecture Repository Updates",
        gate: None,
        s: Tailoring::Skip,
        m: Tailoring::Skip,
        l: Tailoring::P,
    ...
    SectionDef {
        ...
        phase_code: "H",
        number: 4,
        name: "Plan-Qualitaet Retrospektive",
        gate: None,
        s: Tailoring::Skip,
        m: Tailoring::R,
        l: Tailoring::P,
    ...
    SectionDef {
        ...
        phase_code: "H",
        number: 5,
        name: "Next Steps & Change Requests",
        gate: None,
        s: Tailoring::Skip,
        m: Tailoring::R,
        l: Tailoring::P,
...
static HEADING_RE: LazyLock<Regex> =
    LazyLock::new(|| Regex::new(r"^##\s+(P|A|B|C|D|E|F|G|H|RM)\.(\d+)\s+").unwrap());
...
mod tests {
    ...
    fn heading_parsing() {
        assert_eq!(
            heading_to_section_id("## P.1 Architecture Engagement Record"),
            Some("p1".to_string())
        );
        assert_eq!(
            heading_to_section_id("## A.6 Building Blocks (ABBs/SBBs)"),
            Some("a6".to_string())
        );
        assert_eq!(
            heading_to_section_id("## E.4 Implementation Work Packages"),
            Some("e4".to_string())
        );
        assert_eq!(
            heading_to_section_id("## RM.1 Requirements Register"),
            Some("rm1".to_string())
        );
        assert_eq!(
            heading_to_section_id("## RM.3 Traceability Matrix"),
            Some("rm3".to_string())
        );
